# nvim-treesitter-queries-sxhkdrc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sxhkdrc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sxhkdrc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sxhkdrc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sxhkdrc",
...
- [ ] Changes are scoped to `sxhkdrc` — do not include files for other languages
